...
description: "I led controls logic development and built a live simulation interface for FortisBC’s Glendale plant expansion."
date: "2025-04-13"
published: true
---
...
I broke down engineering diagrams and system requirments, then helped lead the design of a 12-condition control logic system, outlining safe operating thresholds for valves, vessels, and compressors. I personally implemented several functions in our **modular, object-oriented Python** program that allowed future conditions to be added easily.
...
- Navigate amgbuity and real world requriements
